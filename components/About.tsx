...
import { PORTFOLIO_STATS } from "./Hero";
  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div>
            ...
            >
              <p className="text-base text-gray-500 dark:text-gray-400 leading-[1.85] font-light">
                I'm a Full Stack Software Engineer with 3+ years of professional
                experience delivering production-grade web applications. I
                specialise in React, Next.js, and Node.js — with a strong focus
                on performance, maintainable architecture, and clean user
                experiences.
              </p>
              <p className="text-base text-gray-500 dark:text-gray-400 leading-[1.85] font-light">
        ...
        {/* ── Stats block REMOVED from About (lives in Hero only) ── */}
      </div>
    </section>
  );
}
