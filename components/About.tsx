          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                a deep love for creating solutions that make a difference.
              </p>

              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                Specializing in the MERN stack, I've had the privilege of
                working on diverse projects ranging from e-commerce platforms to
                real-time chat applications. I believe in writing clean,
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                through technical blogs and mentoring fellow developers.
              </p>
                ...
                <div className="relative">
                  <div className="w-64 h-64 rounded-2xl overflow-hidden shadow-2xl hover:scale-105 transition-transform duration-300">
                    <Image
                      ...
                      alt="Nuruzaman Milon working on code"
                      width={256}
                      height={256}
